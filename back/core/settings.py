...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR.joinpath('../front-reduxToolKit')],
        'APP_DIRS': True,
        'OPTIONS': {
           'context_processors': [
...
STATICFILES_DIRS = [
    BASE_DIR.joinpath('../front-reduxToolKit','../front-reduxToolKit/dist'),
]
...
DJOSER = {
    ...
    'SOCIAL_AUTH_ALLOWED_REDIRECT_URIS': ['http://localhost:5173/google', 'http://localhost:5173/facebook','http://localhost:8000/google'],
    'SERIALIZERS': {
